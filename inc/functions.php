...
function BanUser()
{
	...
	if($_POST['ban_username'] !== '')
	{
		...
		if($query->rowCount() > 0)
		{
			...
			GetMessage("Success!", "You have banned $username from $name.", 3);
		}
		else
		{
...
function CheckIfBanned()
{
	if(Logged() == 1)
	{
		...
		if(GetData($UID, 'banned') == 1)
		{
			...
			echo "Your account is banned from $name. Please contact an administrator if you have any questions regarding your ban.";
			die();
		}
		else
		{
