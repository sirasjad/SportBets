			...
			<div class="row">
							...
							<div class="col-xs-12">
								<form action='' method='POST'>
									...
									<div class="checkbox checkbox-primary">
										...
										<label for="checkbox2">This user is an administrator</label>
									</div>
									
									<label>Subscription days left:</label>
									<input name='email' id='email' class="form-control form-control-lg m-b-20" type='text' value='30' disabled>
									
									<label>Registration date:</label>
									<input name='email' id='email' class="form-control form-control-lg m-b-20" type='text' value='datageni@online.no' disabled>
									
									<center><button type='submit' name='update' class="btn btn-primary waves-effect waves-light btn-lg">Edit User</button></center>
								</form>
							</div>
						</div>
					</div>
				...
				<div class="col-md-12 col-sm-4 col-xs-12 col-xl-4">
					<div class="card-box">
						...
						<p class="text-muted font-13 m-b-30">These tasks will only apply to Datageni's account.</p>

						<div class="row text-xs-center m-t-30">
							<div class="col-xs-12">
								<form action='' method='POST'>
									<button type='submit' name='shoutbox' class='btn btn-warning waves-effect waves-light btn-lg' data-toggle='tooltip' data-placement='top' title='Click here to permanently prune all messages in the shoutbox.'>Reset Password</button>
									
									<button type='submit' name='userlogs' class='btn btn-warning waves-effect waves-light btn-lg' data-toggle='tooltip' data-placement='top' title='Click here to permanently delete all user logs from the database.'>Reset 2FA</button><br></br>
									
									<button type='submit' name='adminlogs' class='btn btn-warning waves-effect waves-light btn-lg' data-toggle='tooltip' data-placement='top' title='Click here to permanently delete all admin logs from the database.'>Clear Admin Logs</button>
									
									<button type='submit' name='unban' class='btn btn-danger waves-effect waves-light btn-lg' data-toggle='tooltip' data-placement='top' title='Click here to unban all banned members from <?php echo $name; ?>.'>Clear All Bans</button>
								</form>
							</div>
						</div>
					</div>
