...
<head>
	...
	<title>Live score - <?php echo $name; ?></title>
</head>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-xs-12 col-lg-12 col-xl-12">
					<div class="card-box">
						<h4 class="header-title m-t-0 m-b-30">Football: Ongoing Matches</h4>
			...
			<div class="row">
				<div class="col-xs-12 col-lg-12 col-xl-12">
					<div class="card-box">
						<h4 class="header-title m-t-0 m-b-30">Basketball: Ongoing Matches</h4>
						<div class="table-responsive">
							<table class="table table-bordered m-b-0">
